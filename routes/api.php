...
Route::get('chi-tiet/{idde}/{iduser}',[DeThiController::class,'getDethichinhthuc']);
Route::put('chuyen-trang-thai/{id}',[DeThiController::class,'chuyentrangthaide']);

// api xoa + sua cau hoi 
Route::post('xoa-cau-hoi', [CauhoiController::class, 'deleteCauHoi']);
Route::put('sua-cau-hoi/{id}', [CauhoiController::class, 'updateCauHoi']);
Route::post('them-cau-hoi',[CauhoiController::class,'addCauHoi']);
...
Route::post('xoa-mon-hoc/{id}',[MonHocController::class,'xoaMonHoc']);
